    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="gap-2 h-9 w-[200px] px-3 rounded-md justify-start -translate-x-0.5 bg-white border-[hsl(216_20%_90%)] text-foreground hover:bg-sidebar hover:border-primary/30"
        >
